...
local opts = {
    ...
    output_label    = "range", -- <increment|range|timestamp|overwrite|chapter>
...
mp.add_key_binding("R", "mode-switch", function() mode_switch("cycle") end)
mp.add_key_binding("r", "stop-cache-write", stop)
mp.add_key_binding("p", "align-cache", align_cache)
mp.add_key_binding("Meta+r", "cache-write", function() cache_write(opts.dump_mode) end)
