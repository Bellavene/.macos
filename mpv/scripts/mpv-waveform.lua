...
mp.add_key_binding("w", "toggle-waveform", toggleFilter)
mp.add_key_binding("W", "cycle-waveform-type", cycleFmt)
mp.add_key_binding("Alt+w", "toggle-waveform-position", togglePos)
