...
-- for macos
url_browser_macos_cmd = "/Users/Klutchevski/CLI/mpv-update-playlist"
file_browser_macos_cmd = "/Users/Klutchevski/CLI/mpv-update-playlist"
-- url_browser_macos_cmd = "open \"$url\""
-- file_browser_macos_cmd = "osascript -e 'set filepath to (POSIX file \"$path\")' -e ''"
-- for windows
...
mp.register_event("file-loaded", locate_current_file)
